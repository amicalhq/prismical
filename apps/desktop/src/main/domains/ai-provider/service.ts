...
export interface AiProviderApi {
  ...
  /** The configured providers as synthetic instance rows (the active provider is always present). */
  ...
  /** Point the device default at a local instance + model; false = not a local instance id. */
