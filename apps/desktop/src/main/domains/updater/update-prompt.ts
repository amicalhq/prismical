import type { UpdateAction, UpdateMetadata } from './machine';
 ...
 * Returns null when nothing
 * should be shown (no update, not downloaded, silent/none, or a non-force
 * prompt the user already dismissed for this version).
 */
