...
export type RecordingSessionSnapshot = Omit<UseRecording,
  'start' | 'pause' | 'resume' | 'stop' | 'clearError' | 'keepRecording' | 'pauseFromPrompt'
> & { retryAvailable: boolean; completedRecording: (RecordingCompletion & { workflowId?: string }) | null };
