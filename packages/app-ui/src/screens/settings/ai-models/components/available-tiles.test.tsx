...
vi.mock('react-i18next', () => ({ useTranslation: () => ({ t: (key: string) => key === 'settings.aiModels.available.requestProvider' ? 'Request Provider' : 'Coming soon' }) }));
afterEach(() => { cleanup(); flags.values = {}; });
