...
// The right-click counterpart of dropdown-menu.tsx: same surfaces, same rows, opened at the pointer.
// Rows keep `cursor-pointer` for the same reason the dropdown's do (see the note there).
