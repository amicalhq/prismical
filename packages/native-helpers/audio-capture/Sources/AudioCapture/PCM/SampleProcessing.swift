...
func resampleLinear(
    ...
    outputSampleCount requestedOutputSampleCount: Int? = nil
) -> [Float] {
    ...
    let outputCount = requestedOutputSampleCount ?? Int(
        (Double(samples.count) * outputSampleRate / inputSampleRate)
