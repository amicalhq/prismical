...
extension SystemAudioCapture {
    ...
    func handle(
        ...
        let fallbackSourceSampleRate: Double?
        ...
        if let selectedInputBuffer {
            ...
            fallbackSourceSampleRate = selectedInputBuffer.format.sampleRate
            ...
            let sourceFormat
        {
            ...
            fallbackSourceSampleRate = sourceSampleRate ?? sourceFormat.sampleRate
            effectiveHostTime =
                outputBytes > 0
